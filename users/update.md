...
Планируется к запуску веб-клиент форумов. Этот формат клиента позволит привлечь иную аудиторию, расширить охват, что в целом пойдёт на пользу всему блокчейну. [Подробнее &gt;](https://golos.id/ru--golos/@lex-escrow/zayavka-na-razrabotku-foruma-veb-klienta-s-otkrytym-kodom)
