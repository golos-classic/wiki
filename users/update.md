...
description: >-
  ...
  Рекомендуем подписаться на аккаунт https://golos.id/@goloschain
---
...
### Приватные сообщения \(мессенджер\)

Возможность обмена приватными/личными сообщениями между пользователями блокчейна Голос в клиентах блогов и форумов. В планах десктоп/смартфон версии мессенджера. [Подробнее &gt;](https://golos.id/ru--golos/@lex-escrow/zayavka-na-realizaciyu-interfeisa-dlya-obmena-lichnymi-soobsheniyami-i-drugie-pravki)
