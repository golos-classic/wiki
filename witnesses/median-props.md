...
Медианные параметры сети доступны на [https://explorer.golos.id](https://explorer.golos.id) или на [https://gapi.golos.today/steemjs/api/database\_api/get\_chain\_properties](https://gapi.golos.today/steemjs/api/database\_api/get\_chain\_properties)
