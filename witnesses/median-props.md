...
Длительность интервала/окна для апвоутов в минутах.
...
Коэффициент "дороговизны бендвича" \(пропускной способности\) для операций custom\_json.
...
~~**worker\_reward\_percent**~~ **\(устарел**, см. [worker\_emission\_percent](median-props.md#worker_emission_percent)**\)**  
Процент от эмиссии в пул воркеров.

~~**witness\_reward\_percent**~~ **\(устарел**, перенесен в конфиг**\)**  
Процент от эмиссии в пул делегатов.

~~**vesting\_reward\_percent**~~ **\(устарел**, см. [vesting\_of\_remain\_percent](median-props.md#vesting_of_remain_percent)**\)**  
